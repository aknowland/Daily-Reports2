...
export function PageHeader({ icon: Icon, title, subtitle, children, className }: PageHeaderProps) {
  return (
    <div className={cn(
      "bg-[hsl(216,32%,15%)] text-white -mx-4 md:-mx-6 lg:-mx-8 px-4 md:px-6 lg:px-8 py-5 mb-6 border-b-2 border-[hsl(36,90%,50%)]",
      className
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            {Icon && (
              <div className="w-10 h-10 rounded bg-[hsl(36,90%,50%)] flex items-center justify-center flex-shrink-0">
                <Icon className="w-5 h-5 text-[hsl(216,32%,10%)]" />
              </div>
            )}
            <div>
  ...
  return (
    <div className={cn("flex items-center justify-between", className)}>
      <div className="flex items-center gap-2">
        <div className="w-1 h-5 bg-[hsl(36,90%,50%)] rounded-full" />
