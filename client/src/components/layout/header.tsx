          ...
          <Link key={`${keyPrefix}${item.href}`} href={item.href} onClick={() => setSheetOpen(false)}>
            <div
              className={cn(
                ...
                isActive 
                  ? "bg-[hsl(38,92%,50%)] text-[hsl(220,55%,10%)] font-bold" 
      ...
      <div className="flex h-14 items-center justify-between gap-4 px-4">
        <div className="flex items-center gap-2">
          {user && (
            <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
              ...
              <SheetContent side="left" className="w-64 overflow-y-auto bg-[hsl(220,55%,16%)] text-white border-r-2 border-[hsl(38,92%,50%)]">
                <SheetHeader>
          ...
          <Link href="/">
            <div className="flex items-center gap-2 cursor-pointer" data-testid="link-home">
              <div className="w-8 h-8 bg-[hsl(38,92%,50%)] flex items-center justify-center">
                <HardHat className="w-5 h-5 text-[hsl(220,55%,10%)]" />
              </div>
              <span className="font-bold text-sm hidden sm:inline tracking-widest uppercase">{title}</span>
            </div>
          </Link>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          {isLoading ? (
              ...
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="rounded-full text-white/80 hover:text-white hover:bg-white/10" data-testid="button-user-menu">
                  <Avatar className="h-9 w-9">
                    ...
                    <AvatarFallback className="bg-[hsl(38,92%,50%)] text-[hsl(220,55%,10%)] text-sm font-bold">
            ...
            <Button asChild className="bg-[hsl(38,92%,50%)] text-[hsl(220,55%,10%)] hover:bg-[hsl(38,92%,44%)] font-bold tracking-wide" data-testid="button-login">
