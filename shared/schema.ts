...
export const teamInspectors = pgTable("team_inspectors", {
  ...
  jobHistory: json("job_history").$type<{title: string; company: string; client?: string; projectName?: string; startDate?: string; endDate?: string; description?: string}[]>().default([]),
